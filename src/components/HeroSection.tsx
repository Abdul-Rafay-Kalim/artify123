...
const HeroSection = () => {
  ...
  return (
    <section id="hero-section" className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-[#efefef]">
      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid md:grid-cols-12 gap-6 items-start relative z-10">
          ...
          <div className="md:col-span-6 opacity-0 animate-fade-in" style={{ animationDelay: "0.1s" }}>
            <h1 className="max-w-[680px] font-serif text-[3.25rem] sm:text-[4rem] md:text-[4.5rem] lg:text-[5.75rem] xl:text-[6.5rem] font-bold leading-[0.95] tracking-[-0.02em] text-foreground">
              Collect Art That<br />
              Lives Beyond<br />
              Trends
            </h1>

            <div className="mt-6 max-w-[680px] text-foreground opacity-0 animate-fade-in" style={{ animationDelay: "0.3s" }}>
              <p className="text-[18px] leading-[1.35] text-foreground/90">
                Discover and collect original artworks from emerging and established
                artists thoughtfully curated.
              </p>
              <p className="mt-1 text-[18px] font-semibold leading-[1.35] text-foreground">
                AI-guided recommendations curated for your space.
              </p>
              <p className="mt-6 text-[18px] leading-[1.35] text-foreground/90">
                Buy original art or share your work with collectors worldwide.
              </p>
            </div>

            <div className="mt-8 flex flex-wrap gap-4 opacity-0 animate-fade-in" style={{ animationDelay: "0.5s" }}>
              <a
                href="/explore"
                className="inline-flex h-14 min-w-[176px] items-center justify-center rounded-full bg-black px-8 text-[18px] font-medium leading-none text-white transition-colors hover:bg-black/85"
              >
                Explore Art
              </a>
              <a
                href="/ai-curator"
                className="inline-flex h-14 min-w-[250px] items-center justify-center rounded-full border border-black/70 bg-transparent px-8 text-[18px] font-medium leading-none text-foreground transition-colors hover:bg-black/5"
              >
          ...
          <div className="md:col-span-6 relative opacity-0 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            ...
            <div className="relative w-full max-w-[300px] sm:max-w-[340px] md:max-w-[420px] lg:max-w-[460px] rounded-3xl overflow-hidden shadow-2xl mx-auto md:ml-auto">
              <img
                src={heroArt}
